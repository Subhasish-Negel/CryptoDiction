...
st.set_page_config(page_title='CryptoPredict 2.0')
...
with st.expander("Click Here to See Tickers of Most of the Popular Crypto Currencies and Companies"):
    col1, col2, col3 = st.columns([1, 1, 1])

    col1.markdown("###### TECH COMPANIES")
    col1.markdown("""
...
if infoType == 'Moving Average Chart':
    ...
    # Plot the histogram
    fig2.add_trace(go.Bar(x=df.index, y=df['macd'], name='histogram', marker_color=colors, ), row=2, col=1)
    ...
    st.subheader('Relative Strength Index (RSI) & Commodity Channel Index (CCI)')
